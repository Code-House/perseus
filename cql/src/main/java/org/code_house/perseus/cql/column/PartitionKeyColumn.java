 ...
 */
public class PartitionKeyColumn<J, C extends DataType> implements WrapperColumn<J, CassandraColumn<J, C>>, CassandraColumn<J, C> {

    private final CassandraColumn<J, C> column;

    public PartitionKeyColumn(CassandraColumn<J, C> column) {
        this.column = column;
    }
